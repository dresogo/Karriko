    ...
    <div className="bg-slate-50 py-10">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="rounded-[1.5rem] border border-slate-200 bg-white p-8 shadow-sm">
          <h1 className="text-3xl font-semibold text-slate-900">AGB</h1>
          <p className="mt-4 text-sm text-slate-500">
            Allgemeine Geschäftsbedingungen von Karriko.
          </p>
          <div className="mt-8 rounded-3xl border border-slate-200 bg-slate-50 p-6 shadow-sm">
            ...
            <p className="mt-2 text-sm text-slate-600">Diese Seite ist ein Platzhalter und wird weiter ausgebaut.</p>
