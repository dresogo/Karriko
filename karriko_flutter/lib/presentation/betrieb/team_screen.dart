...
class _TeamScreenState extends State<TeamScreen> {
  final List<_TeamMember> _members = const [
    _TeamMember(
        name: 'Max Mustermann', email: 'max@beispiel.de', role: 'Admin'),
    _TeamMember(
        name: 'Erika Beispiel', email: 'erika@beispiel.de', role: 'Manager'),
  ];
            ...
            onPressed: () {
              if (formKey.currentState!.validate()) {
                ...
                ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                    content: Text('Einladung an ${emailCtrl.text} gesendet.')));
              }
            },
