            ...
            ? Center(
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Keine gespeicherten Betriebe',
                        style: Theme.of(context).textTheme.headlineSmall),
                    const SizedBox(height: 8),
                    Text(
                        'Merke dir interessante Betriebe, um sie später wiederzufinden.',
                          ...
                          IconButton(
                            ...
                            onPressed: () async {
                              await ref
                                  ...
                                  .removeBookmark(userId, c.id);
                              ref.invalidate(
                                  bookmarkedCompaniesProvider(userId));
                            },
                          ),
                        ],
                      ),
